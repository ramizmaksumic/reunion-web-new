...
<x-page-hero-section title="Digialni marketing" description="Detaljan opis usluga Reunion web & marketing agencije" />
        ...
        <div class="flex flex-col md:flex-row justify-between gap-7 mt-20">
            ...
            <div class="flex flex-col md:w-1/2">
                ...
                <div class="flex flex-wrap gap-3 mt-5 px-5">
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># FACEBOOK</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># INSTAGRAM</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># TIK TOK</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># LINKEDIN</button>
            ...
            <div class="flex flex-col justify-start md:w-1/2">
                ...
                <p class="font-body px-5 md:px-0 text-center md:text-start">
                    Digitalni marketing je širok pojam u ovom dijelu prezentiramo rad na društvenim mrežama i platformama.
                    Sve počinje dobrom strategijom. Na početku svakog novog projekta kreiramo digitalnu strategiju i
                    odlučujemo koje digitalne kanale koristimo. Naši klijenti najčešće imaju profile na mrežama:
                    Facebook & Instagram, neki od njih se odlučuju i za TikTok a neki koriste Youtube platformu ili prezentaciju na mreži LinkedIn.
                </p>
                <p class="mt-5 font-body px-5 md:px-0 text-center md:text-start">Reunion usluga podrazumjeva neke ili sve navedene poslove u vezi društvenih mreža: </p>
                <ul class="mt-5 font-body px-5 md:px-0 text-center md:text-start">
                    <li class="mt-3"><i class="fa-solid fa-check mr-2"></i>Kreiranje digitalne i komunikacijske strategije,</li>
                    <li class="mt-3"><i class="fa-solid fa-check mr-2"></i>Kreiranja profila ili podešavanje postojećih,</li>
                    <li class="mt-3"><i class="fa-solid fa-check mr-2"></i>Kreiranje vizuelnog identiteta, vizuala,</li>
                    <li class="mt-3"><i class="fa-solid fa-check mr-2"></i>Kreiranje sadržaja,</li>
                    <li class="mt-3"><i class="fa-solid fa-check mr-2"></i>Kreiranje kreativnih kampanja, </li>
