...
@section('title', 'Izrada web stranica | Reunion web & marketing Mostar')
@section('meta_description', 'Bavimo se dizajnom i izradom web stranica. Naše web stranice podliježu Reunion web standardu kvalitete, koji garantuje maksimalne performanse, sigurnost i funkcionalnost.')
@section('meta_keywords', 'izrada web stranica Mostar')

@section('og_title', 'Izrada web stranica | Reunion web & marketing agencija Mostar')
@section('og_description', 'Bavimo se dizajnom i izradom web stranica. Naše web stranice podliježu Reunion web standardu kvalitete, koji garantuje maksimalne performanse, sigurnost i funkcionalnost.')
@section('og_image', asset('images/og-mostar.jpg'))

@section('content')

<x-page-hero-section title="Izrada web stranica" description="Dizajniramo web stranice koje su dio marketing strategije, jasne za korisnike i optimizirane da donose upite, prodaju i povjerenje. " />
