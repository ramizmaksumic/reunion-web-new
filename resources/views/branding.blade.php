        ...
        <div class="flex flex-col md:flex-row justify-between gap-7 mt-20">
            ...
            <div class="flex flex-col md:w-1/2">
                ...
                <div class="flex flex-wrap gap-3 mt-5 px-5">
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># GRAFIČKI DIZAJN</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># LOGOTIPI</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># BILBORDI</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># ONLINE PRISUSTVO</button>
                    <button class="bg-secondary py-3 px-5 rounded-xl text-xs cursor-pointer"># STRATEGIJE</button>
                </div>
